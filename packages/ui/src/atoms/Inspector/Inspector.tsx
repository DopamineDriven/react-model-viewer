...
export type InspectorComponentType =
  | "pre"
  | React.JSXElementConstructor<UI.JSX.ReactMapped["pre"]>;

export interface InspectorProps<
  C extends InspectorComponentType = React.JSXElementConstructor<
    UI.JSX.ReactMapped["pre"]
  >
> {
  lang?: UI.JSX.ReactMapped["pre"]["lang"];
  className?: UI.JSX.ReactMapped["pre"]["className"];
...
export type InspectorHTMLType<C extends InspectorComponentType = "pre"> =
  C extends "pre" ? UI.JSX.ReactMapped["pre"] : UI.JSX.ReactMapped["html"];

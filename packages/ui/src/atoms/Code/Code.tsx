...
export type CodeComponentType =
  | "code"
  | React.JSXElementConstructor<UI.JSX.ReactMapped["code"]>;

export interface CodeProps<
  C extends CodeComponentType = React.JSXElementConstructor<
    UI.JSX.ReactMapped["code"]
  >
> {
  lang?: UI.JSX.ReactMapped["code"]["lang"];
  className?: UI.JSX.ReactMapped["code"]["className"];
...
export type CodeHTMLType<C extends CodeComponentType = "code"> =
  C extends "code" ? UI.JSX.ReactMapped["code"] : UI.JSX.ReactMapped["html"];

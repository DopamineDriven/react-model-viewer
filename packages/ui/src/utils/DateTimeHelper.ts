import { TkEnums } from "../typedefs/enum";
...
export const monthToCalendarMonth = (
  parsedMonth: string
): TkEnums.DateTime.Months =>
  parsedMonth.includes("01")
    ? TkEnums.DateTime.Months.January
    : parsedMonth.includes("02")
    ? TkEnums.DateTime.Months.February
    : parsedMonth.includes("03")
    ? TkEnums.DateTime.Months.March
    : parsedMonth.includes("04")
    ? TkEnums.DateTime.Months.April
    : parsedMonth.includes("05")
    ? TkEnums.DateTime.Months.May
    : parsedMonth.includes("06")
    ? TkEnums.DateTime.Months.June
    : parsedMonth.includes("07")
    ? TkEnums.DateTime.Months.July
    : parsedMonth.includes("08")
    ? TkEnums.DateTime.Months.August
    : parsedMonth.includes("09")
    ? TkEnums.DateTime.Months.September
    : parsedMonth.includes("10")
    ? TkEnums.DateTime.Months.October
    : parsedMonth.includes("11")
    ? TkEnums.DateTime.Months.November
    : TkEnums.DateTime.Months.December;

export const relativeValueOfTz = (
  timeZone: keyof typeof TkEnums.DateTime.TimeZones
) => TkEnums.DateTime.TimeZones[timeZone].valueOf();
